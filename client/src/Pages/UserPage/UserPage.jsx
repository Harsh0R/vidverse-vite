        ...
        <>
                        ...
                        <div>
                            {userData[0].chatRoom !== '' && userData[0].chatRoom !== null ?
                                (
                                    ...
                                    <button className={Style.joinRoomBtn} onClick={handleJoinChat}>Join {userData[0].username}'s ChatRoom : {userData[0].chatRoom}</button>
                                ) : (
            ...
            }
            {
                ...
                (
                    <>
                        <button className=
                            {Style.sendButton} onClick={handleLeaveChat}>leave Chat Room : {chatRoomName}</button>
